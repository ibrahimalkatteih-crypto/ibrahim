import 'package:admin_ecommers/contoller/orders/acceptedController.dart';
...
import 'package:admin_ecommers/data/datasourse/remote/orders/pindingData.dart';
  ...
  approveOrder(String usersId,String orderId) async {
    ...
    if (statusRequest == StatusRequest.success) {
      if (response['status'] == 'success') {
        ...
        OrderAcceptedsController controllerAccepted = Get.put(OrderAcceptedsController());
        controllerAccepted.refresh();
        getData();   
      } else {
        statusRequest = StatusRequest.failure;
      }
