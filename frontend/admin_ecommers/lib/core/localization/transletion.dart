...
class MyTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en': {
      ...
      "43": "Added successfully",
      "44": "Enter the name in English",
      "45": "Enter the name in Arabic",
      "46": "Add",
      "47": "choose categories Image",
      "48": "Category deleted",
      "49": "Are you sure you want to delete?",
      "50": "Edit",
      "51": "Edited successfully",
      "52": "choose Item Image",
      '53': 'Write product description in English',
      '54': 'Write product description in Arabic',
      '55': 'Write product quantity',
      '56': 'Write product price',
      '57': 'Write discount discount',
      "58":"camera",
      "59":"gallary",
      "60":"please choose an image",
      "61":"choose categories",
      "62":"Item deleted",
      "63":"is active?",
      "64":"active",
      "65":"inactive",
    ...
    'ar': {
      ...
      "43": "تم الاضافة بنجاح",
      "44": "ادخل الاسم باللغة الانكليزية",
      "45": "أدخل الاسم باللغة العربية",
      "46": "اضافة",
      "47": "اختر صورة القسم",
      "48": "تم حذف القسم",
      "49": "هل انت متأكد من عملية الحذف",
      "50": "اضافة",
      "51": "تم التعديل بنجاح",
      "52": "اختر صورة المنتج",
      "53": "اكتب وصف المنج باللغة الانكليزية",
      "54": "اكتب وصف المنج باللغة العربية",
      "55": "اكتب كمية المنتج",
      "56": "اكتب سعر المنتج",
      "57": "اكتب كمية الخصم",
      "58":"كميرا",
      "59":"استديو",
      "60":"الرجاء اختيار صورة",
      "61":"اختر القسم",
      "62":"تم حذف المنتج",
      "63":"هل هو مفعل؟",
      "64":"نشط",
