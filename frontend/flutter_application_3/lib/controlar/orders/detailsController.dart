...
import 'package:flutter_application_3/data/datasourse/remote/orders/detailsData.dart';
...
class OrdersDetailsController extends GetxController {
  ...
  getData() async {
    ...
    var response = await detailsData.getDataa(orderModel.orderId.toString());
